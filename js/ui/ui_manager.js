window.uiManager = (() => {
    ...
    function updateT2CriteriaControlsUI(currentCriteria, currentLogic) {
        ...
        if (inputSize) {
            ...
            inputSize.disabled = !isSizeActive || isEsgarMode;
        }
        if (valueSize) {
        ...
        ['shape', 'border', 'homogeneity', 'signal'].forEach(key => {
            ...
            if (optionsContainer) {
                optionsContainer.querySelectorAll('.t2-criteria-button').forEach(button => {
                    ...
                    button.classList.toggle('inactive-option', !isKeyActive || isEsgarMode);
                    button.disabled = !isKeyActive || isEsgarMode;
                });
            }
        });
        ...
        if (logicSwitch) {
            ...
            logicSwitch.disabled = isEsgarMode;
        }
