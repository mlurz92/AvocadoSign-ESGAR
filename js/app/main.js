class App {
    ...
    checkDependencies() {
        return new Promise((resolve) => {
            const internalModules = { 
                ...
                resultsTab: window.resultsTab,
                markdownExportService: window.markdownExportService,
    ...
    renderCurrentTab() {
        ...
        switch (tabId) {
            ...
            case 'insights': 
                ...
                break;
            case 'results': 
                window.uiManager.renderTabContent('results', () => window.resultsTab.render(this.allCohortStats)); 
                break;
            case 'export': 
    ...
    exportResultsAsMarkdown() {
        if (!this.allCohortStats) {
            window.uiManager.showToast('No statistics data available for export.', 'warning');
            return;
        }
